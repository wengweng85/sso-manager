...
<head>
    ...
    <link href="<c:url value='/webjars/css/plugins/webuploader/webuploader.css'/>" rel="stylesheet">
    <link href="<c:url value='/webjars/css/demo/webuploader-demo.min.css'/>" rel="stylesheet" >
</head>
<body >
    <body >
    <div class="col-sm-12">
    ...
    <script src="<c:url value='/webjars/js/plugins/webuploader/webuploader.min.js'/>"></script>
    <script src="<c:url value='/webjars/js/json2.js'/>"></script>
    <script src="<c:url value='/webjars/js/rc.webuploader.excelfile.js'/>"></script>
</body>
</html>
