				...
				<div class="ibox-content" id="role_edit_div">
					<form action="<c:url value='/web/role/saveorupdate'/>" class="form-horizontal" method="post" id="myform">
						...
						<div class="form-group">
							 <rc:textedit property="rolecode" label="角色编码 " required="true"  cols="3,9" validate="{required:true,messages:{required:'请输入角色编码'}}" />
						</div>
						<div class="hr-line-dashed"></div>
						<div class="form-group">
							<rc:textedit property="rolename" label="角色名称" required="true"  cols="3,9"   validate="{required:true,messages:{required:'请输入角色名称'}}" />
						</div>
						<div class="hr-line-dashed"></div>
						<div class="form-group">
							<rc:select  property="systypecode"   dynamic="true" label="所属应用类型" required="true"  cols="3,9"  codetype="SYSTYPECODE"  validate="{required:true,messages:{required:'请输入所属应用类型'}}" />
						</div>
						<div class="hr-line-dashed"></div>
						<div class="form-group">
							<rc:textedit property="roledescribe" label="角色描述" required="true"  cols="3,9"  validate="{required:true,messages:{required:'请输入角色描述'}}" />
						</div>
					</form>
		       </div>
          </div>
