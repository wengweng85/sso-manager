		            ...
		            <div class="ibox-content">
						...
						<div id="myTabContent" class="tab-content">
						    <div class="tab-pane fade in active" id="home">
						        <table id="group_person_table" data-url="<c:url value='/web/userrole/getGroupListByType'/>?grouptype=person" 
						    ...
						    <div class="tab-pane fade" id="ios">
						       <table id="group_company_table" data-url="<c:url value='/web/userrole/getGroupListByType'/>?grouptype=company" 
						          data-click-to-select="false"
			                      data-show-export="true"
			                      data-pagination="true"
			                      data-uniqueId="1"
...
$('#roletable').on('click-row.bs.table', function (e, row, $element) {
	open_web_role_perm_tree(row.roleid);
});

//打开角色对应权限树页面
function open_web_role_perm_tree(roleid){
	layer.open({
	  type: 2,
	  title: '角色对应权限树',
	  shadeClose: true,
	  ...
	  shade: 0.8,
	  area: ['30%', '80%'],
	  content:"<c:url value='/web/role/role_perm_index/'/>"+roleid     //iframe的url
	});
}
