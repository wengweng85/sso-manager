			...
			<div class="ibox-content" >
				<form action="<c:url value='/sys/role/saveorupdate'/>" class="form-horizontal" method="post" id="myform">
					...
					<div class="form-group">
						<rc:textedit property="rolecode"   value="${srole.rolecode }" label="角色编码 " required="true"  cols="2,10" validate="{required:true,messages:{required:'请输入角色编码'}}" />
					</div>
						<div class="hr-line-dashed"></div>
					<div class="form-group">
						<rc:textedit property="rolename"   value="${srole.rolename }"  label="角色名称" required="true"  cols="2,10" validate="{required:true,messages:{required:'请输入角色名称'}}" />
					</div>
					<div class="hr-line-dashed"></div>
					<div class="form-group">
						<rc:textedit property="roledescribe"  value="${srole.roledescribe }"  label="角色描述" required="true"  cols="2,10"  validate="{required:true,messages:{required:'请输入角色描述'}}" />
					</div>
				</form>
			</div>
		</div>
