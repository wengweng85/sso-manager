		...
		<div class="col-sm-9">
			<div class="ibox ">
				<div class="ibox-title">
					<h5>权限编辑区</h5>
					<div class="ibox-tools">
					    <button  onclick="sys_perm_savePermData()" class="btn btn-primary btn-xs"><i class="fa fa-save"></i>保存</button>
		            </div>
				</div>
				<div class="ibox-content">
				<form action="<c:url value='/sys/perm/saveorupdate'/>"  class="form-horizontal" method="post" id="myform">
                       ...
                       <div class="hr-line-dashed"></div>
                       <div class="form-group">
                           <rc:select codetype="PERMTYPE" property="permtype"  label="权限类型" required="true"  cols="2,10" validate="{required:true,messages:{required:'请选择权限类型'}}"/> 
                       </div>
                       <div class="hr-line-dashed"></div>
                       <div class="form-group">
...
function addDetailSubTreeNode() {
	...
	current_detail_selectedNodes=zDetailTree.getSelectedNodes()[0];
	sys_right_menu_perm_addnewperm(current_detail_selectedNodes.id,current_detail_selectedNodes.permname);
}
