...
<head>
    ...
    <link href="<c:url value='/webjars/css/plugins/iCheck/custom.css'/>" rel="stylesheet">
...
<div class="middle-box text-center loginscreen  animated fadeInDown">
    ...
    <script src="<c:url value='/webjars/js/jQuery/all/jquery.js'/>"></script>
    <script src="<c:url value='/webjars/js/bootstrap.min.js'/>"></script>
    <script src="<c:url value='/webjars/js/plugins/iCheck/icheck.min.js'/>"></script>
    <script src="<c:url value='/webjars/js/plugins/layer/layer.min.js"'/>"></script>
    <script src="<c:url value='/webjars/js/rc.all-2.0.js'/>"></script>
    <script src="<c:url value='/webjars/js/RSA.js'/>"></script>
</body>
