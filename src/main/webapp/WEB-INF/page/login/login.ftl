...
<style type="text/css">
body{
    background:url(${website_static_resource_url}/webjars/img/loginDialog/background.jpg) no-repeat 0 0 scroll;
}
#text-title{
...
/*核心中间部分内容*/
#center_right{
 float:right;width:390px; height:400px; background:url(${website_static_resource_url}/webjars/img/loginDialog/text_backbg.png) no-repeat;
...
<body>
    ...
    <script src="${website_static_resource_url}/webjars/js/RSA.js"></script>
</body>
