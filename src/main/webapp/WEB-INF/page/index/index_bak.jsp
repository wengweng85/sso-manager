...
<head>
    ...
    <!-- Morris -->
    <link href="<c:url value='/webjars/css/plugins/morris/morris-0.4.3.min.css'/>" rel="stylesheet">

    <!-- Gritter -->
    <link href="<c:url value='/webjars/js/plugins/gritter/jquery.gritter.css'/>" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <script src="<c:url value='/webjars/js/plugins/flot/jquery.flot.js'/>"></script>
    <script src="<c:url value='/webjars/js/plugins/flot/jquery.flot.tooltip.min.js'/>"></script>
    <script src="<c:url value='/webjars/js/plugins/flot/jquery.flot.spline.js'/>"></script>
    <script src="<c:url value='/webjars/js/plugins/flot/jquery.flot.resize.js'/>"></script>
    <script src="<c:url value='/webjars/js/plugins/flot/jquery.flot.pie.js'/>"></script>
    <script src="<c:url value='/webjars/js/plugins/flot/jquery.flot.symbol.js'/>"></script>
    <script src="<c:url value='/webjars/js/plugins/peity/jquery.peity.min.js'/>"></script>
    <script src="<c:url value='/webjars/js/demo/peity-demo.min.js'/>"></script>
    <script src="<c:url value='/webjars/js/plugins/jquery-ui/jquery-ui.min.js'/>"></script>
    <script src="<c:url value='/webjars/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js'/>"></script>
    <script src="<c:url value='/webjars/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js'/>"></script>
    <script src="<c:url value='/webjars/js/plugins/easypiechart/jquery.easypiechart.js'/>"></script>
    <script src="<c:url value='/webjars/js/plugins/sparkline/jquery.sparkline.min.js'/>"></script>
    <script src="<c:url value='/webjars/js/demo/sparkline-demo.min.js'/>"></script>
    <script>
