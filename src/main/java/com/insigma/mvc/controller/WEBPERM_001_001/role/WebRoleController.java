...
public class WebRoleController extends MvcHelper  {
	 ...
	 * @return
	 */
	@RequestMapping("/role_perm_index/{roleid}")
	public ModelAndView role_perm_index(HttpServletRequest request,Model model,@PathVariable String roleid) throws Exception {
		ModelAndView modelAndView=new ModelAndView("webperm/WEBPERM_001_001/role/webRolePermTreeIndex");
